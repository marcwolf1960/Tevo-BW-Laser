...
class laser_gcode(inkex.Effect):
	...
	self.OptionParser.add_option("",   "--gc-header",                       action="store", type="string",          dest="gc_header",                           default="G28",                          help="GCode Start")
	...
	self.OptionParser.add_option("",   "--gc-end",                          action="store", type="string",          dest="gc_end",                              default="G28",                          help="GCode End")
	...
	self.OptionParser.add_option("",   "--obj-height",                      action="store", type="string",          dest="obj_height",                          default="0",                            help="Object Height")
...
#                    print_((-f(w[k][i-1]),-f(w[k][i]), [i1[5] for i1 in l1]) )
    ...
    def check_dir(self):
        ...
        if (os.path.isdir(self.options.directory)):
            ...
            self.header += "G0 Z" + self.options.obj_height + "\n"
